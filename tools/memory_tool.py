...
MEMORY_SCHEMA = {
    ...
    "description": (
        ...
        "- You discover something about the machine environment (OS, installed tools, runtime config)\n"
        ...
        "Do NOT save project-specific knowledge (repo details, build configs, API specifics) "
        "to memory; file those directly into project files in the workspace.\n"
        "If you've discovered a new way to do something, solved a problem that could be "
        "necessary later, save it as a skill with the skill tool.\n\n"
        "TWO TARGETS:\n"
        "- 'user': who the user is -- name, role, preferences, communication style, pet peeves\n"
        "- 'memory': your notes -- machine/environment facts, tool quirks, cross-cutting operational knowledge\n\n"
